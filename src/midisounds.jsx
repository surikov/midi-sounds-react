...
class MIDISounds extends React.Component {
  constructor(props) {
    super(props);
	console.log('MIDISounds v1.2.34');
    this.state = {
      showModal: false
    ...
    var r = (
      <div className="MIDISounds">
		<div onClick={this.handleOpenModal}>
			<svg version="1.2" width="20mm" height="20mm" viewBox="0 0 1800 1000" preserveAspectRatio="xMidYMid" >
			 <g>
			  <g>
			   <g>
				<g>
				 <g>
				  <g>
				   <g>
					<path fill="rgb(111,145,124)" stroke="none" d="M 924,0 L 750,0 750,630 924,630 924,0 Z"/>
				   </g>
				  </g>
				  <g>
				   <g>
					<path fill="rgb(111,145,124)" stroke="none" d="M 1794,0 L 1620,0 1620,630 1794,630 1794,0 Z"/>
				   </g>
				  </g>
				  <g>
				   <g>
					<path fill="rgb(111,145,124)" stroke="none" d="M 1160,479 L 1386,479 1386,151 987,151 987,0 1496,0 C 1528,0 1557,26 1557,60 L 1557,570 C 1557,604 1528,630 1496,630 L 987,630 987,240 1160,240 1160,479 Z"/>
				   </g>
				  </g>
				  <g>
				   <g>
					<path fill="rgb(111,145,124)" stroke="none" d="M 624,0 L 513,0 0,0 0,630 171,630 171,151 258,151 258,630 427,630 427,151 513,151 513,630 686,630 686,60 C 686,26 660,0 624,0 Z"/>
				   </g>
				  </g>
				  <g>
				   <g>
				  ...
				  <g>
				   <g>
					<path fill="rgb(111,145,124)" stroke="none" d="M 1179,707 L 1179,1154 1077,1154 1016,951 1016,1154 919,1154 919,707 1016,707 1082,908 1082,707 1179,707 Z"/>
				   </g>
				  </g>
				  <g>
				   <g>
            ...
            <table align="center">
				<tbody>
					<tr>
						...
						<td style={this.state.master<1/9?STYLE.tdOff:STYLE.tdOn} onClick={(e)=>this.setMasterVolume(1/9)}></td>
						<td style={this.state.master<2/9?STYLE.tdOff:STYLE.tdOn} onClick={(e)=>this.setMasterVolume(2/9)}></td>
						<td style={this.state.master<3/9?STYLE.tdOff:STYLE.tdOn} onClick={(e)=>this.setMasterVolume(3/9)}></td>
						<td style={this.state.master<4/9?STYLE.tdOff:STYLE.tdOn} onClick={(e)=>this.setMasterVolume(4/9)}></td>
						<td style={this.state.master<5/9?STYLE.tdOff:STYLE.tdOn} onClick={(e)=>this.setMasterVolume(5/9)}></td>
						<td style={this.state.master<6/9?STYLE.tdOff:STYLE.tdOn} onClick={(e)=>this.setMasterVolume(6/9)}></td>
						<td style={this.state.master<7/9?STYLE.tdOff:STYLE.tdOn} onClick={(e)=>this.setMasterVolume(7/9)}></td>
						<td style={this.state.master<8/9?STYLE.tdOff:STYLE.tdOn} onClick={(e)=>this.setMasterVolume(8/9)}></td>
						<td style={this.state.master<9/9?STYLE.tdOff:STYLE.tdOn} onClick={(e)=>this.setMasterVolume(9/9)}></td>
					</tr>
				</tbody>
			</table>
